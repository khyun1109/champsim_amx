...
public:
  ...
  bool isBusy(PHYSICAL_REGISTER_ID physreg) const;
  bool isAllocated(PHYSICAL_REGISTER_ID archreg) const;
  PHYSICAL_REGISTER_ID frontend_RAT_lookup(int16_t archreg) const;
  uint16_t get_arch_reg(PHYSICAL_REGISTER_ID physreg) const;
